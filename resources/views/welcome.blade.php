...
<html lang="en">
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="{{asset('temp/images/fevicon.png')}}" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="{{asset('temp/css/jquery.mCustomScrollbar.min.css')}}">
   ...
   <body>
      ...
      <div class="header_section haeder_main">
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <span style="font-size:30px;cursor:pointer; color: #fff;" onclick="openNav()"><img src="{{asset('temp/images/toggle-icon.png')}}"></span>
               <a class="navbar-brand" href="index.html"><img src="{{asset('temp/images/logo.png')}}"></a></a>
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="#"><img src="{{asset('temp/images/user-icon.png')}}"></a></li>
                        <li><a href="#"><img src="{{asset('temp/images/trolly-icon.png')}}"></a></li>
                        <li><a href="#"><img src="{{asset('temp/images/search-icon.png')}}"></a></li>
                     </ul>
                  </div>
               </form>
            </nav>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row border_1">
                        <div class="col-md-4">
                           <div class="image_1"><img src="{{asset('temp/images/img-1.png')}}" style="width:100%"></div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           <div class="image_2"><img src="{{asset('temp/images/img-2.png')}}" style="width:100%"></div>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="computers_section_2">
         <div class="container-fluid">
            <div class="computer_main">
               <div class="row">
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{asset('temp/images/computer-img.png')}}"></div>
                  ...
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{asset('temp/images/laptop-img.png')}}"></div>
                  ...
                  <div class="col-md-4">
                     <div class="computer_img"><img src="{{asset('temp/images/mac-img.png')}}"></div>
         ...
         <div class="container-fluid">
            <div class="mans_main">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="image_3"><img src="{{asset('temp/images/img-3.png')}}"></div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            ...
            <div class="womans_section_2">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="image_4"><img src="{{asset('temp/images/img-4.png')}}"></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="footer_section layout_padding margin_top_90">
         <div class="container">
            <div class="footer_logo_main">
               <div class="footer_logo"><a href="index.html"><img src="{{asset('temp/images/footer-logo.png')}}"></a></div>
               <div class="social_icon">
                  <ul>
                     <li><a href="#"><img src="{{asset('temp/images/fb-icon.png')}}"></a></li>
                     <li><a href="#"><img src="{{asset('temp/images/twitter-icon.png')}}"></a></li>
                     <li><a href="#"><img src="{{asset('temp/images/linkedin-icon.png')}}"></a></li>
                     <li><a href="#"><img src="{{asset('temp/images/instagram-icon.png')}}"></a></li>
                     <li><a href="#"><img src="{{asset('temp/images/youtub-icon.png')}}"></a></li>
                  </ul>
               </div>
            </div>
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="call_text"><img src="{{asset('temp/images/map-icon.png')}}"><span class="paddlin_left_0"><a href="#">London 145 United Kingdom</a></span></div>
                     <div class="call_text"><img src="{{asset('temp/images/call-icon.png')}}"><span class="paddlin_left_0"><a href="#">+7586656566</a></span></div>
                     <div class="call_text"><img src="{{asset('temp/images/mail-icon.png')}}"><span class="paddlin_left_0"><a href="#">volim@gmail.com</a></span></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <script src="{{asset('temp/js/plugin.js')}}"></script>
      <!-- sidebar -->
      <script src="{{asset('temp/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
      <script src="{{asset('temp/js/custom.js')}}"></script>
      <!-- javascript --> 
      <script src="{{asset('temp/js/owl.carousel.js')}}"></script>
